...
export class ReminderCardComponent implements OnInit {
  ...
  constructor(private authService: AuthService, private alertify: AlertifyService, private reminderService: ReminderService) { }

  ngOnInit() {}

  deleteReminder() {
    this.reminderService.deleteReminder(this.authService.decodedToken.nameid, this.reminder.reminderId).subscribe(() => {
